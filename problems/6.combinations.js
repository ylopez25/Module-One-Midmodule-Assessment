...
*/
function removeValuesAtOddIndices() {

}

/** Write a function that returns all the values from 1 to n inclusive, replacing all numbers that are a multiple of seven, or contain seven with "BOOM".  If a number is both a multiple of seven, and contains a seven, replace it with "BOOMBOOM" instead.
* Sample Input: 20
* Sample Output: [1,2,3,4,5,6,BOOMBOOM,8,9,10,11,12,13,BOOM,15,16,BOOM,18,19,20]
